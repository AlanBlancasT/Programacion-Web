...
class DatosPersonalesModelo{
    ...
    public function insertarDatos($Id, $nombre, $edad, $telefono){
        try {
    ...
    public function actualizarDatos($Id, $nombre, $edad, $telefono){
        try {
            $sql = "UPDATE datos SET nombre = :nombre, edad = :edad, telefono = :telefono WHERE Id = :Id";
            $consulta = $this->conexion->prepare($sql);
            $consulta->bindParam(':nombre', $nombre);
            $consulta->bindParam(':edad', $edad);
            $consulta->bindParam(':telefono', $telefono);
